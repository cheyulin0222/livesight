...
import com.arplanets.corexrapi.ticket.dto.JwkDto;
import com.arplanets.corexrapi.ticket.dto.JwksResponse;
...
public class JwksController {
    ...
    @GetMapping(value = "/api/ticket/.well-known/jwks.json", produces = MediaType.APPLICATION_JSON_VALUE)
